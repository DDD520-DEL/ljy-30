import type { House, Roommate, BorrowRecord, InventoryItem, ChoreTask, ChoreAssignment, ChoreRotation, Announcement, Wish, Poll, PollVote, MaintenanceRecord, Photo } from '@/types';
...
const PHOTO_IMAGE = (prompt: string, size: 'square' | 'portrait_4_3' | 'landscape_4_3') =>
...
export const MOCK_PHOTOS: Photo[] = [
  {
    id: 'ph1',
    houseId: 'h1',
    url: PHOTO_IMAGE('合租室友一起吃火锅聚餐，温馨的餐桌，丰富的食材，热气腾腾', 'landscape_4_3'),
    thumbnailUrl: PHOTO_IMAGE('合租室友一起吃火锅聚餐，温馨的餐桌，丰富的食材，热气腾腾', 'landscape_4_3'),
    title: '周末火锅聚餐',
    description: '四个人围在一起吃火锅，太开心了！',
    category: 'dining',
    uploaderId: 'r1',
    uploaderName: '小明',
    uploaderAvatar: '🐱',
  ...
  },
  {
    id: 'ph2',
    houseId: 'h1',
    url: PHOTO_IMAGE('温馨整洁的合租公寓客厅，有绿植装饰，暖色调灯光，沙发抱枕', 'portrait_4_3'),
    thumbnailUrl: PHOTO_IMAGE('温馨整洁的合租公寓客厅，有绿植装饰，暖色调灯光，沙发抱枕', 'portrait_4_3'),
    title: '客厅大改造完成！',
    description: '大家一起动手把客厅重新布置了一遍，焕然一新~',
    category: 'decoration',
    uploaderId: 'r2',
    uploaderName: '小红',
    uploaderAvatar: '🐰',
  ...
  },
  {
    id: 'ph3',
    houseId: 'h1',
    url: PHOTO_IMAGE('生日派对场景，蛋糕、气球、彩带，朋友们一起庆祝', 'square'),
    thumbnailUrl: PHOTO_IMAGE('生日派对场景，蛋糕、气球、彩带，朋友们一起庆祝', 'square'),
    title: '大壮的生日派对',
    description: '祝大壮生日快乐！🎂🎉',
    category: 'party',
    uploaderId: 'r4',
  ...
  },
  {
    id: 'ph4',
    houseId: 'h1',
    url: PHOTO_IMAGE('合租厨房做早餐，桌上有面包、牛奶、煎蛋，阳光洒进来', 'landscape_4_3'),
    thumbnailUrl: PHOTO_IMAGE('合租厨房做早餐，桌上有面包、牛奶、煎蛋，阳光洒进来', 'landscape_4_3'),
    title: '一起做的早餐',
    description: '早起一起做了份丰盛的早餐，元气满满！',
    category: 'daily',
    uploaderId: 'r3',
    uploaderName: '大壮',
    uploaderAvatar: '🐻',
  ...
  },
  {
    id: 'ph5',
    houseId: 'h1',
    url: PHOTO_IMAGE('四个年轻人在郊外公园野餐，蓝天白云，草地美食', 'portrait_4_3'),
    thumbnailUrl: PHOTO_IMAGE('四个年轻人在郊外公园野餐，蓝天白云，草地美食', 'portrait_4_3'),
    title: '周末出游野餐',
    description: '天气好的时候一起去公园野餐，太惬意了~',
    category: 'travel',
    uploaderId: 'r1',
    uploaderName: '小明',
    uploaderAvatar: '🐱',
  ...
  },
  {
    id: 'ph6',
    houseId: 'h1',
    url: PHOTO_IMAGE('合租阳台小花园，各种绿植花盆，阳光明媚', 'square'),
    thumbnailUrl: PHOTO_IMAGE('合租阳台小花园，各种绿植花盆，阳光明媚', 'square'),
    title: '我们的阳台小花园',
    description: '每个人认领一盆植物，阳台变成小花园啦！',
    category: 'decoration',
    uploaderId: 'r2',
    uploaderName: '小红',
    uploaderAvatar: '🐰',
  ...
  },
  {
    id: 'ph7',
    houseId: 'h1',
    url: PHOTO_IMAGE('家里一起看电影，投影仪、爆米花、沙发，温馨氛围', 'landscape_4_3'),
    thumbnailUrl: PHOTO_IMAGE('家里一起看电影，投影仪、爆米花、沙发，温馨氛围', 'landscape_4_3'),
    title: '家庭电影之夜',
    description: '周末一起窝在沙发上看电影，配着爆米花~',
    category: 'daily',
    uploaderId: 'r3',
    uploaderName: '大壮',
    uploaderAvatar: '🐻',
  ...
  },
  {
    id: 'ph8',
    houseId: 'h1',
    url: PHOTO_IMAGE('四个室友一起包饺子，厨房热闹场景，各种馅料', 'portrait_4_3'),
    thumbnailUrl: PHOTO_IMAGE('四个室友一起包饺子，厨房热闹场景，各种馅料', 'portrait_4_3'),
    title: '一起包饺子过冬至',
    description: '冬至大家一起动手包饺子，虽然包的歪歪扭扭但是超好吃！',
    category: 'dining',
    uploaderId: 'r4',
    uploaderName: '阿花',
    uploaderAvatar: '🦊',
